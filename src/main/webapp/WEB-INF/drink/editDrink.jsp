            ...
            <div class="content">
                ...
                <div class="">
                    <div class="page-header-title">
                        <h1 class="page-title">Chỉnh sửa thông tin thức uống</h1>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card">
                                    ...
                                    <c:if test="${requestScope['drink']  != null}">
                                    <form method="post" class="mt-5">
                                        <input type="text" name="id" value="${drink.id}" hidden>
                                        <input type="text" name="statusDrink" value="${drink.status.value}" hidden>
                                        <div class="form-group col-12 text-center">
                                            ...
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend" style="width: 15%">
                                                        <span class="input-group-text font-weight-bold"
                                                              style="width: 100%">Giá thức uống</span>
                                                </div>
                                            ...
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend" style="width: 15%">
                                                        <span class="input-group-text font-weight-bold"
                                                              style="width: 100%">Mô tả</span>
                                                </div>
                                                <input type="text" aria-label="Mô tả" class="form-control"
                                                       value="${drink.desc}" name="descDrink">
                                            </div>
